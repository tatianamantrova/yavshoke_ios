...
final class LoginPage {
    ...
    private var titleLabel: XCUIElement { app.staticTexts["loginTitle"].firstMatch }
    ...
    private var loginButton: XCUIElement { app.buttons["loginButton"].firstMatch }
    ...
    func checkEmailPlaceholderIsDisplayed() -> Self {
        checkEditTextPlaceholder(for: emailField, with: "Email")
